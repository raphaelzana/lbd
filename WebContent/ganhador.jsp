			...
			<div class="login-form login-form-left"> 
				<div class="agile-row">
					...
					<div class="login-agileits-top"> 	
							<% 
							String ganhador = session.getAttribute("ganhador").toString();
							%>
						<form action="ControllerSorteio" method="post">							
							<input type="text" class="name" name="hash" Placeholder=<%=ganhador %> required/>
							<input  name="botao" value="1 GELINHO"> 
						</form> 	
					</div> 
